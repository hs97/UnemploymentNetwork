...
for j in range(J):
    sec_to_shock = dfA['short_names'][j]
    ...
    xlab = ''
    ylab = '$\ d\log y$ (pct.)'
    save_path = f'../output/figures/paper/all_sec/{sec_to_shock}_AshockY'
    ...
    if do_unemployment:
        ...
        xlab = ''
        ylab = '$d \log \\theta$  (pct.)'
        save_path = f'../output/figures/paper/all_sec/{sec_to_shock}_AshockT'
        ...
        xlab = ''
        ylab = '$d \log U$  (pct.)'
        save_path = f'../output/figures/paper/all_sec/{sec_to_shock}_AshockU'
        labels = ['Labor Market Frictions + Production Linkages', 'Labor Market Frictions Only', 'Production Linkages Only']
        ...
        save_path = f'../output/figures/paper/all_sec/{sec_to_shock}_AshockUrate'
        labels = ['Labor Market Frictions + Production Linkages', 'Labor Market Frictions Only', 'Production Linkages Only']
